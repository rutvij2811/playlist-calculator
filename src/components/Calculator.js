	...
	return (
		<div className="container m-auto">
			<div className="relative flex-grow w-full mt-5 px-5">
				...
				<input
					type="text"
					placeholder="PLu0W_9lII9ag1cN0n_UcNRN7fYIwNYJDQ"
					className="mt-2 w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-blue-500 focus:bg-transparent focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
					id="pid"
					value={pid}
			...
			<button
				onClick={handleClick}
				className="mt-3 text-white mx-5 bg-blue-800 border-0 py-2 px-8 focus:outline-none hover:bg-blue-900 hover:scale-105 rounded text-md">
				Get Total Time
			</button>
